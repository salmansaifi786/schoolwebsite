...
function readFormData() {
    ...
    formData["tadd"] = document.getElementById("tadd").value;
...
function onEdit(td) {
    ...
    document.getElementById("tadd").value = selectedRow.cells[3].innerHTML;
...
function updateRecord(formData) {
    ...
    selectedRow.cells[3].innerHTML = formData.tadd;
...
function validate() {
    ...
    // Tadd validation
    if (document.getElementById("tadd").value == "") {
        isValid = false;
